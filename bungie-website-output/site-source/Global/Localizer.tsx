...
const localizerProxy: FancyLocalizerDict = new Proxy(
  {},
  {
    get(_, propName: string, __) {
      ...
      const fallbackEnabled = ConfigUtils.GetParameter(
        SystemNames.Localizer,
        "XMLEnglishFallbackEnabled",
        true
      );
          ...
          get(___, stringName: string, ____) {
            ...
            if (fileStrings) {
              ...
              if (innerValue !== undefined) {
                ...
                // In production, use English strings as fallback
...
class StringFetcherInternal extends DataStore<{
  ...
  public fetch(force = false) {
    ...
    const englishJsonUrl = `/JsonLocalizer.ashx?lc=en&lcin=${lcin}&nc=true&bv=${cacheString}`;

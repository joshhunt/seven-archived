...
> {
  ...
  private updateSettings() {
    return Platform.CoreService.GetCommonSettings()
      .then((data) => {
        this.update({
          coreSettings: data,
        });

        this.storeCoreSettings(data);
      })
      .catch((e) => {
        Modal.error(e);
  ...
  private updateCurrentUser(bustCache) {
    ...
    return Platform.UserService.GetCurrentUser(queryAppend).then((data) => {
      this.update({
        loggedInUser: data,
      });
    });

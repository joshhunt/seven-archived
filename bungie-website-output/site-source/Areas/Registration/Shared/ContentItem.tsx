...
/**
 * ContentItem - used to render contentItems in the Registration Area Only
 *  *
 * @param {IContentItemProps} props
 * @returns
 */
export const ContentItem: React.FC<IContentItemProps> = (
  props: IContentItemProps
) => {
...
export const ContentSet: React.FC<IContentItemProps> = (
  props: IContentItemProps
) => {
  const contentItem = props.contentItem;
...
export const RegistrationItemContent: React.FC<IContentItemProps> = (
  props: IContentItemProps
) => {
  const contentItem = props.contentItem;
  const def = props.definition;
...
export const GenericBanner: React.FC<IContentItemProps> = (
  props: IContentItemProps
) => {
  const contentItem = props.contentItem;
  const leftAlign =

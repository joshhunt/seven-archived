...
> {
  ...
  public render() {
    ...
    const { productFamilies, skuItems } = this.state;
    ...
    return (
      <div className={styles.content}>
        ...
        {this.renderCollectorsEdition(
          beyondLightSkus.find(
            (value) => value.skuTag === this.collectorsEditionSku
          )
        )}
      </div>
    );
        ...
        <div className={styles.collectorsEdition}>
          ...
          <div className={styles.textContent}>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: productDef.blurb }}
            />
            <Button buttonType={"blue"} url={productDef.relatedPage}>

...
interface IGameHistoryState {
  currentActivityFilter: Globals.DestinyActivityModeType;
  activityHistoryForPlatformAndCharacter: HistoricalStats.DestinyActivityHistoryResults;
}
...
> {
  constructor(props: GameHistoryProps) {
    ...
    this.state = {
      ...
      activityHistoryForPlatformAndCharacter: null,
    };
  }

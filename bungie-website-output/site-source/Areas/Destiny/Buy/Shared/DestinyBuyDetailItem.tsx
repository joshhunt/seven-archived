...
> {
  ...
  public render() {
    const { item, orientation, skuItem, collectorsEdition } = this.props;
    ...
    return item || skuItem ? (
      <div className={classNames(styles.container, styles[orientation])}>
        <MediaSection
          ...
          videoTitle={
            item ? item.videoTitle : collectorsEdition && skuItem.disclaimer
          }
        ...
        <TextSection
          ...
          buttonColor={collectorsEdition ? "blue" : "gold"}
          buttonLabel={
            item ? item.buttonLabel : collectorsEdition && skuItem.buttonLabel
          }
          buttonSku={item ? item.buttonSku : null}
          buttonUrl={
            item ? item.buttonLink : collectorsEdition && skuItem.relatedPage
          }
          orientation={orientation}
        />
      </div>

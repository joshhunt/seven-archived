...
> {
  ...
  private readonly getRewardsHistory = () => {
    ...
    if (ConfigUtils.SystemStatus("PartnerOfferClaims")) {
      // note that the default value here: "0" is actually the Bungie HistoryAppIdSource value for Bungie.
      const sourceAppId = Number(
      ...
      if (
        ...
        if (canViewHistory || !membershipId) {
          ...
          Platform.TokensService.GetPartnerOfferSkuHistory(
            ...
            .then((data) => this.setState({ rewards: data, sourceAppId }))
      ...
      <SystemDisabledHandler systems={["PartnerOfferClaims"]}>
        <RequiresAuth>
          ...
          {this.state.loggedInUserCanReadHistory ? (
            ...
            // if this isn't your membershipId in the url or you're not an admin, you don't get to see my goodies!
            <div>
              <p className={styles.noResults}>
